...
A modified version of [Basecamp's](https://basecamp.com/) [Trix editor](http://trix-editor.org) for use in scientific applications.
...
Bug reports and pull requests are welcome on GitHub at https://github.com/DRBragg/trix-scientific. This project is intended to be a safe, welcoming space for collaboration, and contributors are expected to adhere to the [Contributor Covenant](http://contributor-covenant.org) code of conduct.
...
This project is a direct modification of [Basecamp's](https://basecamp.com/) [Trix WYSIWYG editor](http://trix-editor.org).  Without their time and effort this wouldn't exist.
